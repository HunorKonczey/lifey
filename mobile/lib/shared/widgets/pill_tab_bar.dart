...
/// the others 600 in the secondary text colour. (The bar used to fill the
/// active tab with brand olive; the design keeps olive for actions, not for
/// "where am I".)
///
...
class PillTabBar extends StatelessWidget {
  const PillTabBar({
    ...
    required this.tabs,
    this.horizontalMargin = AppSpacing.screen,
  });

  final TabController controller;
  final List<Widget> tabs;

  /// Side margin — the design's screen margin by default, so the bar lines up
