...
| **C8.6** | **Időjárás mező** (Q-C8.1: kézi bevitel, nincs külső API) — hőmérséklet, szél, csapadék, a hátizsák-súlyéval azonos „kézzel" szerkesztési mintával | `presentation/log_cardio_sheet.dart`, `presentation/cardio_summary_screen.dart` | **M42** | Nincs hálózati hívás, tehát nincs mit időzíteni vagy hibakezelni — az edzés indulása emiatt **soha nem késhet** (a régi kész-ha triviálisan teljesül). Megadás nélkül a mező **üres marad, nem 0** (M42 „nincs időjárás-adat" állapota erre vált) |
