...
// Adatkezelési tájékoztató / Privacy Policy (docs/landing_page/65 Prompt 8,
// 68 §6). Draft content — not yet reviewed by counsel; see this prompt's
// landed notes in 65-web-landing-page-plan.md.
...
export async function generateMetadata({
  ...
  return buildMetadata({ locale, href: "/legal/privacy", title: t("metaTitle"), description: t("metaDescription") });
}
