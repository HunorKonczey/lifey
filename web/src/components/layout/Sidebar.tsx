...
export function Sidebar() {
  ...
  return (
    <aside
      className="flex flex-col shrink-0 h-screen sticky top-0 transition-all duration-[var(--dur-base)]"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-5">
        ...
        {!collapsed && (
          <span className="font-bold text-lg tracking-tight">Lifey</span>
        )}
        <button
          onClick={() => setCollapsed((c) => !c)}
          className="ml-auto p-1 rounded-[var(--r-sm)] transition-colors hover:bg-surface-highest"
      ...
      <div className="flex flex-col gap-1 px-2 pb-4">
        ...
        >
          <span
            className="material-symbols-rounded text-xl shrink-0"
            style={{
              fontVariationSettings: pathname.startsWith("/settings") ? "'FILL' 1" : "'FILL' 0",
            }}
          >
            settings
          </span>
