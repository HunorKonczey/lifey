 ...
 */
final class DailyStepCountMapper {

    private DailyStepCountMapper() {
    }

    static DailyStepCount toEntity(DailyStepCountRequest request) {
    ...
    static DailyStepCountResponse toResponse(DailyStepCount entry) {
