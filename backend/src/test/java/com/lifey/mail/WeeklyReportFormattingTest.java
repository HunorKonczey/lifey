...
public class WeeklyReportFormattingTest {
    ...
    void summarize_noActivity_returnsSingleFallbackLine() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 0, 0, 0, 0, 0.0, 0, null, null, null, null);
    ...
    void summarize_missedWorkoutOnly_stillCountsAsActivity() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 0, 1, 0, 0, 0.0, 0, null, null, null, null);
    ...
    void summarize_noGoalSet_omitsWithinGoalCount() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 3, 0, 3, 0, 0.0, 5, null, 2150, null, null);
    ...
    void summarize_withGoal_includesWithinGoalCount() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 3, 0, 3, 0, 0.0, 5, 4, 2150, null, null);
    ...
    void summarize_noWeighIn_saysSo() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 1, 0, 1, 0, 0.0, 1, null, 2000, null, null);
    ...
    void summarize_singleWeighInWithoutBaseline_omitsChange() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 1, 0, 1, 0, 0.0, 1, null, 2000, 82.4, null);
    ...
    void summarize_weightChange_showsSignedDelta() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 1, 0, 1, 0, 0.0, 1, null, 2000, 82.0, -0.4);
    ...
    void summarize_html_usesBrSeparators() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 1, 0, 1, 0, 0.0, 0, null, null, null, null);
    ...
    void summarize_largeCalorieCount_notGroupedByLocale() {
        ...
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 3, 0, 3, 0, 0.0, 5, null, 12345, null, null);

        assertThat(formatting.summarize(summary, MailLanguage.EN, false)).contains("avg 12345 kcal");
    }

    @Test
    void summarize_cardioWorkouts_addsBreakdownLineWithDistanceInKm() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 5, 0, 3, 2, 10500.0, 0, null, null, null, null);

        String text = formatting.summarize(summary, MailLanguage.EN, false);

        assertThat(text).contains("3 strength · 2 cardio · 10.5 km");
        assertThat(formatting.summarize(summary, MailLanguage.HU, false)).contains("3 erősítő · 2 cardio · 10.5 km");
    }

    @Test
    void summarize_noCardioWorkouts_omitsBreakdownLine() {
        var summary = new WeeklyTrainerReport.ClientWeekSummary("jane", 3, 0, 3, 0, 0.0, 0, null, null, null, null);

        assertThat(formatting.summarize(summary, MailLanguage.EN, false)).doesNotContain("strength").doesNotContain("cardio");
    }
