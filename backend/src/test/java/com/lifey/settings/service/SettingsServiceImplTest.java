...
class SettingsServiceImplTest {
    ...
    void update_canDisableWorkoutReminder() {
        ...
        SettingsRequest request = new SettingsRequest(UnitSystem.METRIC, null, null, null, null, null, null,
                ThemePreference.SYSTEM, LanguagePreference.SYSTEM, false, true, true, true, true, true, 90);
    ...
    void update_canDisableTrainerCommentPush() {
        ...
        SettingsRequest request = new SettingsRequest(UnitSystem.METRIC, null, null, null, null, null, null,
                ThemePreference.SYSTEM, LanguagePreference.SYSTEM, true, false, true, true, true, true, 90);
    ...
    void update_canDisableTrainerGoalsPush() {
        ...
        SettingsRequest request = new SettingsRequest(UnitSystem.METRIC, null, null, null, null, null, null,
                ThemePreference.SYSTEM, LanguagePreference.SYSTEM, true, true, false, true, true, true, 90);
    ...
    void update_canDisableProgramAssignedPush() {
        ...
        SettingsRequest request = new SettingsRequest(UnitSystem.METRIC, null, null, null, null, null, null,
                ThemePreference.SYSTEM, LanguagePreference.SYSTEM, true, true, true, false, true, true, 90);
